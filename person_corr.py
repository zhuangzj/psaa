...
def main():
    ...
    df2 = pd.read_csv('D:/WorkSpace/PSSA/pssa/task_score_relevance3.csv', skiprows=1, names=['stuId', '601_score', '601_ol', '601_sl', '601_ml', '601_wl', '601_om', '601_sm', '601_mm', '601_wm', '601_os', '601_ss', '601_ms', '601_ws', '601_on', '601_sn', '601_mn', '601_wn', '601_o!s', '601_s!s', '601_m!s', '601_w!s',
    ...
    score_df = df[['601_score', '701_score', '801_score']]
    score_df['total'] = score_df['601_score'] + score_df['701_score'] + score_df['801_score']
    #print(df2)
